...
public class UserDetailUpdateRequest {
	...
	public static UserDetailUpdateRequest of(UserDetailUpdateJMSRequest updateRequest) {
		UserDetailUpdateRequest request = new UserDetailUpdateRequest();
		request.setAddress(updateRequest.getAddress());
		request.setAge(updateRequest.getAge());
		request.setMobileNumber(updateRequest.getMobileNumber());
		return request;
	}
}
